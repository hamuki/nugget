...
contains(NUGGET_NEED_QT_PLUGINS, 1) {
    DEFINES += NUGGET_NEED_QT_PLUGINS
...
SOURCES += src/qt/nugget.cpp src/qt/nuggetgui.cpp \
    ...
    src/qt/nuggetaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/nuggetstrings.cpp \
    src/qt/nuggetamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/nugget.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/nugget_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/nugget-qt.rc
...
windows:RC_FILE = src/qt/res/nugget-qt.rc
...
macx:ICON = src/qt/res/icons/nugget.icns
macx:TARGET = "nugget-Qt"
