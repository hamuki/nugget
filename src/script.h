...
#ifndef H_NUGGET_SCRIPT
#define H_NUGGET_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CNuggetAddress
 */
...
public:
    ...
    // Pre-version-0.6, Nugget always counted CHECKMULTISIGs
